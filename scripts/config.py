...
DatasetName = Enum(
    "DatasetName", ["nyu_data"]
)
DatasetName_blender = Enum(
    "DatasetName", ["LivingRoom1"]
)
DatasetName_train_icl = Enum(
    "DatasetName", [ "nyu_data"]
)

DatasetName_train_blender = Enum(
    "DatasetName", [ "LivingRoom1"]
)
...
class SimpleDiopter(Experiment):
    ...
    batch_size = 8
    learning_rate = 1e-4
    # train = [ DatasetName_train.living_traj2,DatasetName_train.office_traj3]
